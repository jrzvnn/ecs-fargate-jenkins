...
resource "aws_ecs_task_definition" "this" {
  ...
  container_definitions = templatefile("${path.module}/container_definition.tftpl", {
    ...
    container_image         = "${data.aws_caller_identity.this.account_id}.dkr.ecr.us-east-2.amazonaws.com/${var.application_name}:jenkins-controller",
    ...
    jenkins_agent_image             = "${data.aws_caller_identity.this.account_id}.dkr.ecr.us-east-2..amazonaws.com/${var.application_name}:jenkins-agent",
